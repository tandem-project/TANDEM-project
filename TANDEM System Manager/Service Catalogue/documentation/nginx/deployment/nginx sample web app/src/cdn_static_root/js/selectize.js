...
!function (e, t) {
    ...
    e.prototype.tokenize = function (e) {
        ...
        var t, i, o, s, r, a, l, p = this, c = !(e = p.prepareSearch(e, n)).query && n.sort_empty || n.sort,
            u = function (e, t) {
        ...
        return (s = d.length) ? 1 === s ? (o = d[0].field, r = a[0], function (e, t) {
            return r * h(u(o, e), u(o, t))
        }) : function (e, t) {
            for (var n, i = 0; i < s; i++) if (n = d[i].field, n = a[i] * h(u(n, e), u(n, t))) return n;
            return 0
        } : null
        ...
        return n = s.options, e = s.query, o = n.score || t.getScoreFunction(s), e.length ? t.iterator(t.items, function (e, t) {
            i = o(e), (!1 === n.filter || 0 < i) && s.items.push({score: i, id: t})
...
var highlight = function (e, t) {
    if ("string" != typeof t || t.length) {
        var r = "string" == typeof t ? new RegExp(t, "i") : t, a = function (e) {
            var t = 0;
            if (3 === e.nodeType) {
...
var IS_MAC = /Mac/.test(navigator.userAgent), KEY_A = 65, KEY_COMMA = 188, KEY_RETURN = 13, KEY_ESC = 27, KEY_LEFT = 37,
    ...
    isset = function (e) {
        ...
        return e ? (Selectize.$testInput || (Selectize.$testInput = $("<span />").css({
            ...
            padding: 0,
            whiteSpace: "pre"
        }).appendTo("body")), Selectize.$testInput.text(e), transferStyles(t, Selectize.$testInput, ["letterSpacing", "fontSize", "fontFamily", "fontWeight", "textTransform"]), Selectize.$testInput.width()) : 0
    }, autoGrow = function (r) {
        function e(e, t) {
            var n, i, o, s;
...
MicroEvent.mixin(Selectize), "undefined" != typeof MicroPlugin ? MicroPlugin.mixin(Selectize) : logError("Dependency MicroPlugin is missing", {explanation: 'Make sure you either: (1) are using the "standalone" version of Selectize, or (2) require MicroPlugin before you load Selectize.'}), $.extend(Selectize.prototype, {
    setup: function () {
        var e, t = this, n = t.settings, i = t.eventNS, o = $(window), s = $(document), r = t.$input,
            a = t.settings.mode, l = r.attr("class") || "",
            p = $("<div>").addClass(n.wrapperClass).addClass(l).addClass(a),
            c = $("<div>").addClass(n.inputClass).addClass("items").appendTo(p),
            u = $('<input type="text" autocomplete="off" />').appendTo(c).attr("tabindex", r.is(":disabled") ? "-1" : t.tabIndex),
        ...
        (d = r.attr("id")) && (u.attr("id", d + "-selectized"), $("label[for='" + d + "']").attr("for", d + "-selectized")), t.settings.copyClassesToDropdown && h.addClass(l), p.css({width: r[0].style.width}), t.plugins.names.length && (e = "plugin-" + t.plugins.names.join(" plugin-"), p.addClass(e), h.addClass(e)), (null === n.maxItems || 1 < n.maxItems) && t.tagType === TAG_SELECT && r.attr("multiple", "multiple"), t.settings.placeholder && u.attr("placeholder", n.placeholder), !t.settings.splitOn && t.settings.delimiter && (e = t.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"), t.settings.splitOn = new RegExp("\\s*" + e + "+\\s*")), r.attr("autocorrect") && u.attr("autocorrect", r.attr("autocorrect")), r.attr("autocapitalize") && u.attr("autocapitalize", r.attr("autocapitalize")), u[0].type = r[0].type, t.$wrapper = p, t.$control = c, t.$control_input = u, t.$dropdown = h, t.$dropdown_content = a, h.on("mouseenter mousedown click", "[data-disabled]>[data-selectable]", function (e) {
        ...
        var i, o, s, r, a = this;
        a.$activeOption && a.$activeOption.removeClass("active"), a.$activeOption = null, (e = $(e)).length && (a.$activeOption = e.addClass("active"), !t && isset(t) || (i = a.$dropdown_content.height(), o = a.$activeOption.outerHeight(!0), t = a.$dropdown_content.scrollTop() || 0, e = (r = s = a.$activeOption.offset().top - a.$dropdown_content.offset().top + t) - i + o, i + t < s + o ? a.$dropdown_content.stop().animate({scrollTop: e}, n ? a.settings.scrollDuration : 0) : s < t && a.$dropdown_content.stop().animate({scrollTop: r}, n ? a.settings.scrollDuration : 0)))
    }, selectAll: function () {
        var e = this;
        ...
        var t, n, i, o, s, r, a, l, p, c, u, d, h, g;
        void 0 === e && (e = !0);
        var f = this, v = $.trim(f.$control_input.val()), m = f.search(v), y = f.$dropdown_content,
            w = f.$activeOption && hash_key(f.$activeOption.attr("data-value")), C = m.items.length;
        ...
        }), c = document.createDocumentFragment(), t = 0, C = s.length; t < C; t++) l = s[t], f.optgroups.hasOwnProperty(l) && o[l].childNodes.length ? ((u = document.createDocumentFragment()).appendChild(f.render("optgroup_header", f.optgroups[l])), u.appendChild(o[l]), c.appendChild(f.render("optgroup", $.extend({}, f.optgroups[l], {
            html: domToString(u),
            dom: u
        })))) : c.appendChild(o[l]);
        ...
        (d = f.canCreate(v)) && (y.prepend(f.render("option_create", {input: v})), g = $(y[0].childNodes[0])), f.hasOptions = 0 < m.items.length || d, f.hasOptions ? (0 < m.items.length ? ((w = w && f.getOption(w)) && w.length ? h = w : "single" === f.settings.mode && f.items.length && (h = f.getOption(f.items[0])), h && h.length || (h = g && !f.settings.addPrecedence ? f.getAdjacentOption(g, 1) : y.find("[data-selectable]:first"))) : h = g, f.setActiveOption(h), e && !f.isOpen && f.open()) : (f.setActiveOption(null), e && f.isOpen && f.close())
        ...
        var t, n, i, o, s, r, a = this, l = e && e.keyCode === KEY_BACKSPACE ? -1 : 1,
    ...
    function o(e, r) {
        ...
        function l(e, t) {
            ...
            (i || c.allowEmptyOption) && (p.hasOwnProperty(i) ? t && ((n = p[i][f]) ? $.isArray(n) ? n.push(t) : p[i][f] = [n, t] : p[i][f] = t) : ((n = a(e) || {})[d] = n[d] || e.text(), n[h] = n[h] || i, n[g] = n[g] || e.prop("disabled"), n[f] = n[f] || t, p[i] = n, s.push(n), e.is(":selected") && r.items.push(i)))
        }
    ...
    var s = $.fn.selectize.defaults, c = $.extend({}, s, i), u = c.dataAttr, d = c.labelField, h = c.valueField,
        g = c.disabledField, f = c.optgroupField, v = c.optgroupLabelField, m = c.optgroupValueField;
    return this.each(function () {
        ...
        this.selectize || (e = $(this), t = this.tagName.toLowerCase(), (n = e.attr("placeholder") || e.attr("data-placeholder")) || c.allowEmptyOption || (n = e.children('option[value=""]').text()), ("select" === t ? o : function (e, t) {
            var n, i = e.attr(u);
            if (i) for (t.options = JSON.parse(i), s = 0, r = t.options.length; s < r; s++) t.items.push(t.options[s][h]); else {
                i = $.trim(e.val() || "");
                if (c.allowEmptyOption || i.length) {
                    for (var o, e = '(".*?"|[^"' + c.delimiter + "s]+)(?=s*" + c.delimiter + "|s*$)", e = new RegExp(e, "g"), s = 0, r = (o = i.match(e)).length; s < r; s++) (n = {})[d] = o[s].replace(/"/g, ""), n[h] = o[s], t.options.push(n);
                    t.items = o
                }
            }
        })(e, n = {placeholder: n, options: [], optgroups: [], items: []}), new Selectize(e, $.extend(!0, {}, s, n, i)))
    })
}, $.fn.selectize.defaults = Selectize.defaults, $.fn.selectize.support = {validity: SUPPORTS_VALIDITY_API}, Selectize.define("drag_drop", function (e) {
    ...
    var i, a = this;
    r = $.extend({equalizeWidth: !0, equalizeHeight: !0}, r), this.getAdjacentOption = function (e, t) {
        var n = e.closest("[data-group]").find("[data-selectable]"), t = n.index(e) + t;
        return 0 <= t && t < n.length ? n.eq(t) : $()
