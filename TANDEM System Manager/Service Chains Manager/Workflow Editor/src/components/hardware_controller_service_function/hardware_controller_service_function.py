...
def hardware_controller_service_function(service_function_name, 
...
parser = argparse.ArgumentParser(description='command line arguments for hardware controller service function.')
...
if __name__ == '__main__':
	hardware_controller_service_function(args.service_function_name, 
