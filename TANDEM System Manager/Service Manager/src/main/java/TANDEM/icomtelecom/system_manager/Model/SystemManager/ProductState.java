...
public class ProductState {
  ...
  public boolean equals(Object o) {
    ...
    ProductState productstate = (ProductState) o;
    return Objects.equals(this.name, productstate.name) &&
        Objects.equals(this.id, productstate.id) &&
        Objects.equals(this.next, productstate.next) ;
  }
