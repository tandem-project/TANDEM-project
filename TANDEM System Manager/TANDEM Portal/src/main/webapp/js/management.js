...
async function runServicePopUp(divId, service) {
    ...
    htmltxt += "</form>\
                <div class='row'>\
                    <input id='add-operation-btn' type='button' value='Run Service' onclick=\"runService('" + divId + "', '" + service.serId + "')\">\
                </div>\
                </div>";
...
async function runService(divId, serviceId)
{
...
//            console.log("tableConfParams = " + tableConfParams);

            // Get configuration parameters from selected service and create the call's body
            var instantiateServiceBody = '{';
//            console.log("service.serConfigParams = " + service.serConfigParams);
//            console.log("service.serConfigParams.length = " + service.serConfigParams.length);
