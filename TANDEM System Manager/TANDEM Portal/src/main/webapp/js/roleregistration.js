...
<td>\n\
                ...
                iconsarr1.push('<i class="fas fa-edit" onclick="openEditRole('+i+')" title="Edit" style="color:blue;font-size:18px"></i>');
        ...
        for (var i = 11; i < jsonroles.length; i++) { 
                ...
                var iconsarr1 = JSON.parse("[]");
                iconsarr1.push('<i class="fas fa-edit" onclick="openEditRole('+i+')" title="Edit" style="color:blue;font-size:18px"></i>');
                iconsarr1.push('<i class="far fa-trash-alt" onclick="deleteRole('+i+')" title="Delete" style="color:red;font-size:18px"></i>');
        ...
        iconstab["rows"] = JSON.parse("[]");
        var iconsarr1 = JSON.parse("[]");
        iconsarr1.push('<i class="fas fa-edit" onclick="openEditRole('+num+')" title="Edit" style="color:blue;font-size:18px"></i>');
        iconsarr1.push('<i class="far fa-trash-alt" onclick="deleteRole('+num+')" title="Delete" style="color:red;font-size:18px"></i>');
...
<td>\n\
        ...
        for (var i = 11; i < jsonroles.length; i++) { 
            ...
            var iconsarr1 = JSON.parse("[]");
            iconsarr1.push('<i class="fas fa-edit" onclick="openEditRole('+i+')" title="Edit" style="color:blue;font-size:18px"></i>');
            iconsarr1.push('<i class="far fa-trash-alt" onclick="deleteRole('+i+')" title="Delete" style="padding:2px;color:red;font-size:22px"></i>');
            iconstab["rows"].push(iconsarr1);
