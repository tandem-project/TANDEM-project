...
public class NodeCapacity {
    ...
    @JsonProperty("nodeMaxNoofPods")
    private Integer nodeMaxNoofPods = null;
    ...
    public Integer getNodeMaxNoofPods() {
        return nodeMaxNoofPods;
    }

    public void setNodeMaxNoofPods(Integer nodeMaxNoofPods) {
        this.nodeMaxNoofPods = nodeMaxNoofPods;
    }
