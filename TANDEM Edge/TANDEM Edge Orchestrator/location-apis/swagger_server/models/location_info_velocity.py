...
class LocationInfoVelocity(Model):
    ...
    def bearing(self) -> int:
        ...
        Bearing, expressed in the range 0° to 360°, as defined in ETSI TS 123 032 [14].  # noqa: E501
    ...
    def horizontal_speed(self) -> int:
        ...
        Horizontal speed, expressed in km/h and defined in ETSI TS 123 032 [14].  # noqa: E501
    ...
    def uncertainty(self) -> int:
        ...
        Horizontal uncertainty, as defined in ETSI TS 123 032 [14]. Present only if \"velocityType\" equals 3 or 4  # noqa: E501
    ...
    def velocity_type(self) -> int:
        ...
        Velocity information, as detailed in ETSI TS 123 032 [14], associated with the reported location coordinate: <p>1 = HORIZONTAL <p>2 = HORIZONTAL_VERTICAL <p>3 = HORIZONTAL_UNCERT <p>4 = HORIZONTAL_VERTICAL_UNCERT  # noqa: E501
    ...
    def vertical_speed(self) -> int:
        ...
        Vertical speed, expressed in km/h and defined in ETSI TS 123 032 [14]. Present only if \"velocityType\" equals 2 or 4  # noqa: E501
    ...
    def vertical_uncertainty(self) -> int:
        ...
        Vertical uncertainty, as defined in ETSI TS 123 032 [14]. Present only if \"velocityType\" equals 4  # noqa: E501
