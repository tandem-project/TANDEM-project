...
class UserInfo(Model):
    ...
    """
    def __init__(self, access_point_id: str=None, address: str=None, ancillary_info: str=None, context_location_info: str=None, location_info: LocationInfo=None, resource_url: str=None, timestamp: TimeStamp=None, zone_id: str=None, user_type: str =None):  # noqa: E501
        ...
        :type zone_id: str
        :param user_type: The type of this UserInfo.  # noqa: E501
        :type user_type: str
        """
        self.swagger_types = {
            'access_point_id': str,
    ...
    def user_type(self) -> str:
        ...
        Type of user (e.g. 'user' or 'device')
