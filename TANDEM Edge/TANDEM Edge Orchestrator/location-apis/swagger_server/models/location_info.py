...
from swagger_server.models.location_info_velocity import LocationInfoVelocity  # noqa: F401,E501
...
class LocationInfo(Model):
    ...
    def accuracy(self) -> int:
        ...
        Horizontal accuracy / (semi-major) uncertainty of location provided in meters, as defined in ETSI TS 123 032 [14]. Present only if \"shape\" equals 4, 5 or 6  # noqa: E501
    ...
    def accuracy_altitude(self) -> int:
        ...
        Altitude accuracy / uncertainty of location provided in meters, as defined in ETSI TS 123 032 [14]. Present only if \"shape\" equals 3 or 4  # noqa: E501
    ...
    def confidence(self) -> int:
        ...
        Confidence by which the position of a target entity is known to be within the shape description, expressed as a percentage and defined in ETSI TS 123 032 [14]. Present only if \"shape\" equals 1, 4 or 6  # noqa: E501
    ...
    def orientation_major_axis(self) -> int:
        ...
        Angle of orientation of the major axis, expressed in the range 0° to 180°, as defined in ETSI TS 123 032 [14]. Present only if \"shape\" equals 4 or 6  # noqa: E501
