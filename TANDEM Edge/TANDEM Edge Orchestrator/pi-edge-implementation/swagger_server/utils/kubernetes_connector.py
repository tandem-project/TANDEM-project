...
def get_PoP_statistics(nodeName):
    ...
    for pop in x1['items']:
        ...
        if name==nodeName:
            ...
            node_general_info={}
            node_general_info["nodeOS"]=pop['status']['node_info']['os_image']
            node_general_info["nodeKubernetesVersion"]=pop['status']['node_info']['kubelet_version']
            node_general_info["nodecontainerRuntimeVersion"]=pop['status']['node_info']['container_runtime_version']
            node_general_info["nodeKernelVersion"]=pop['status']['node_info']['kernel_version']
            node_general_info["nodeArchitecture"]=pop['status']['node_info']['architecture']
