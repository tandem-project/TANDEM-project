...
class DeployPaas(Model):
    ...
    """
    def __init__(self, paas_service_name: str=None, paas_instance_name: str=None, autoscaling_type: str=None, count_min: int=None, count_max: int=None, location: str=None, all_node_ports: bool=None, monitoring_services: bool=None, node_ports: List[int]=None):  # noqa: E501
